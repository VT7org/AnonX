...
OWNER_ID: int = get_env_int("OWNER_ID", 5960968099)
...
SUPPORT_GROUP: str = getenv("SUPPORT_GROUP", "https://t.me/BillaCore")
SUPPORT_CHANNEL: str = getenv("SUPPORT_CHANNEL", "https://t.me/BillaSpace")
